...
public class BedServiceImpl implements BedService {
	...
	public ResponseEntity<ResponseStructure<Bed>> saveBed(Bed bed) {
		...
		ResponseEntity<ResponseStructure<Bed>> responseEntity = new ResponseEntity<ResponseStructure<Bed>>(
	...
	public ResponseEntity<ResponseStructure<Bed>> updateBed(int id, Bed bed) {
		Bed bed2 = bedDao.updateBed(id, bed);
		if (bed2 != null) {
	...
	public ResponseEntity<ResponseStructure<List<Bed>>> getAllBed() {
		...
		if (beds != null) {
			...
			ResponseEntity<ResponseStructure<List<Bed>>> responseEntity = new ResponseEntity<ResponseStructure<List<Bed>>>(
					responseStructure, HttpStatus.OK);
	...
	public ResponseEntity<ResponseStructure<String>> deleteBed(int id) {
		...
		if (bedDao.deleteBed(id)) {
			responseStructure.setStatus(HttpStatus.OK.value());
			responseStructure.setMessage("success");
			responseStructure.setData("Bed deleted");
